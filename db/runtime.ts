...
const CATALOG_2026_RULE_SET_SEED_BINDINGS = [
  ...
  [
    ...
    "NASM-CPT recertification guidance and handbook; use the expiration date printed on the certificate. Complete 2.0 CEUs, including 0.1 CEU for current adult CPR/AED, and do not carry CEUs into another cycle. Record non-preapproved education only after NASM approves its petition. NASM expressly accepts its own ASTI online CPR/AED course; confirm acceptance before counting a different third-party online-only course because NASM's official materials conflict.",
    null,
    "2026-07-26",
    "source_linked_check_conditions",
    1,
...
const CATALOG_2026_CATEGORY_SEED_BINDINGS = [
  ...
  [
    ...
    "nasm-cpt-2026-non-cpr-recertification",
    "optional",
    "Use this classifier for CEUs awarded through a NASM/AFAA approved provider. Record only the CEUs printed on the completion certificate, and follow the NASM portal for education completed during its 90-day grace period.",
  ...
  [
    ...
    "nasm-cpt-2026-non-cpr-recertification",
    "optional",
    "Use this classifier for NASM-accepted industry contributions. A petitioned activity contributes zero until NASM approves it, so retain the approval with the activity evidence.",
    "NASM CEU activity type",
    2,
  ],
  [
    ...
    "nasm-cpt-2026-non-cpr-recertification",
    "optional",
    "Use this classifier for NASM-accepted collegiate coursework. Record the NASM-awarded CEU value rather than deriving CEUs locally from academic credits or contact hours.",
    "NASM CEU activity type",
    3,
  ],
  [
