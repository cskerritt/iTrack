...
const CATALOG_2026_RULE_SET_SEED_BINDINGS = [
  ...
  [
    ...
    "SHRM Recertification Handbook and qualifying-activities guidance; use the cycle dates and accepted values shown in the SHRM portal. Earn 60 PDCs, with no more than 30 for Advance Your Organization and 30 for Advance Your Profession. SHRM has no general ethics or inclusion minimum. Current official materials conflict: the handbook lists 10 SHRM membership PDCs per year while current web guidance lists 3, and they disagree on whether all excess or only Education PDCs may carry. iTrack does not auto-award membership or carryover; manually record only values accepted or posted by SHRM, with portal-confirmed carryover capped at 20 PDCs.",
    null,
    "2026-07-26",
    "source_linked_check_conditions",
    1,
...
const CATALOG_2026_CATEGORY_SEED_BINDINGS = [
  ...
  [
    ...
    "shrm-cp-2026-education",
    "conditional",
    "Record only the carryover amount SHRM posts in the new cycle. iTrack tracks that portal-confirmed amount under Advance Your Education, caps it at 20 PDCs, and does not reconstruct it from prior activities.",
    "SHRM PDC category",
    3,
  ],
  [
